...
#Com mes correlacio positiva més tendencia a tenir valors anomals <- justificació 
```
...
As we can see in the output condes$quanti, price variable is related with tax, mpg, mileage and years_sell variables because their p-values are less than 0.05.
More concretely, against more price less mpg, less mileage and less years_sell. 
