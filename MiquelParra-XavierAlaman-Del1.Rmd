...
More concretely, against more price less mileage, less years_sell and less mpg. 
...
As we can see in the output catdes$quanti.var, we can feature that µ_AudiNo, µ_AudiYes and µ_mpg are not the same because the p-value is less than 0.05.
