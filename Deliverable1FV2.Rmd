...
anova(m4pet,m4)
```
As we can see transmission variable is significant/useful, because the p-value of anova test is less than 0.05, that means that the 2 models are not equivalent and, therefore, the big one is better. 
...
anova(m4pet,m4)
```
As we can see fuelType variable is significant/useful, because the p-value of anova test is less than 0.05, that means that the 2 models are not equivalent and, therefore, the big one is better. 
...
anova(m4pet,m4)
```
As we can see manufacturer variable is significant/useful, because the p-value of anova test is less than 0.05, that means that the 2 models are not equivalent and, therefore, the big one is better. 
...
anova(m4pet,m4)
```
As we can see engineSize_num variable is significant/useful, because the p-value of anova test is less than 0.05, that means that the 2 models are not equivalent and, therefore, the big one is better.
...
We can see that within hybrid category, the mpg variable causes the logarithm of the price decrease by 9.45 units.
We can see that being within the other category and diesel category (baseline) is the same, because the p-value is greater than 0.05.
We can see that within petrol category, the mpg variable causes the logarithm of the price increase by 1.53 units.
...
```
As we can see price variable is related to fuelType and mpg variables, because the p-value of anova test is less than 0.05, that means that the 2 models are not equivalent and, therefore, the big one is better.
We can see that within hybrid category, the mpg variable causes the logarithm of the price increase by 0.011 units.
We can see that being within the other category and diesel category (baseline) is the same, because the p-value is greater than 0.05.
We can see that within petrol category, the mpg variable causes the logarithm of the price decrease by 0.0058 units.
...
As we can see price variable is related to fuelType and mpg variables, because the p-value of anova test is less than 0.05, that means that the 2 models are not equivalent and, therefore, the big one is better.
We can see that being within the hybrid category and diesel category (baseline) is the same, because the p-value is greater than 0.05.
We can see that being within the other category and diesel category (baseline) is the same, because the p-value is greater than 0.05.
We can see that within petrol category, the mpg variable causes the logarithm of the price decrease by 0.0068 units.
...
summary(m1)
```
As we can see the only useful variable is the mpg variable, because its p-value is less than 0.05. 
