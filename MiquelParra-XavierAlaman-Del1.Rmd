...
barplot(table(res.immca$completeObs[,"model"]),col="blue")
```
...
barplot(table(res.immca$completeObs[,"year"]),col="blue")
```
...
barplot(table(res.immca$completeObs[,"transmission"]),col="blue")
```
...
barplot(table(res.immca$completeObs[,"fuelType"]),col="blue")
```
...
barplot(table(res.immca$completeObs[,"manufacturer"]),col="blue")
```
