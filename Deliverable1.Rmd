...
We have considered to impute hybrid cars because they cause noise.//REVISARRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
es a dir SÍ imputar cotxes hybrids o NO
```{r}
par(mfrow=c(1,1))
...
```{r}
fviz_contrib(res.mca, choice = "ind", axes = 1:5, top = 20)#NOOOOOOOOOOOOOOOOOOOOOOOOOOOO EM DEIXA POSAR 1:9
```
...
```
The parangons of cluster 1 are
The parangons of cluster 2 are
The parangons of cluster 3 are
The parangons of cluster 4 are
The parangons of cluster 5 are
The parangons of cluster 6 are
The parangons of cluster 7 are

The dist/distants of cluster 1 are
The dist/distants of cluster 2 are
The dist/distants of cluster 3 are
The dist/distants of cluster 4 are
The dist/distants of cluster 5 are
The dist/distants of cluster 6 are
The dist/distants of cluster 7 are
